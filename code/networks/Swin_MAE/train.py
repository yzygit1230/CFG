...
def get_args_parser():
    parser = argparse.ArgumentParser('Swin MAE pre-training', add_help=False)
    ...
    parser.add_argument('--data_path', default=r'data/breastMae', type=str)  
    ...
    # other parameters
    parser.add_argument('--output_dir', default='./output_dir_25',
                        help='path where to save, empty for no saving')
    parser.add_argument('--log_dir', default='./output_dir_25',
